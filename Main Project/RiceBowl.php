...
<head>
   ...
   <title>Rice Bowl Restaurant</title>
...
<section class="header">
   ...
   <a href="#" class="logo"> <i class="fas fa-utensils"></i> Rice Bowl Restaurant</a>
   ...
   <div class="swiper home-slider">
      ...
      <div class="swiper-wrapper">
         ...
         <div class="swiper-slide slide" style="background: url(Images/openkitchenhome-slide-1.jpg) no-repeat;">
            <div class="content">
               <span>Rice Bowl Restaurant</span>
...
<section class="about" id="about">
   ...
   <div class="image">
      <img src="Images\rice bowl.jpg" alt="">
   </div>
