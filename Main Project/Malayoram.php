...
<section class="header">
   ...
   <a href="#" class="logo"> <i class="fas fa-utensils"></i> Hotel Malayoram</a>
...
<section class="about" id="about">
   ...
   <div class="image">
      <img src="Images\Malayoram.jpg" alt="">
   </div>
