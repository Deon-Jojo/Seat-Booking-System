...
<head>
   ...
   <title>Kuttanad Restaurant</title>
...
<section class="header">
   ...
   <a href="#" class="logo"> <i class="fas fa-utensils"></i> Kuttanadu Restaurant</a>
...
<section class="about" id="about">
   ...
   <div class="image">
      <img src="Images/Kuttanad.jpg" alt="">
   </div>
