...
<section class="header">
   ...
   <a href="#" class="logo"> <i class="fas fa-utensils"></i> Town Bakery</a>
...
<section class="about" id="about">
   ...
   <div class="image">
      <img src="Images\town bakery.jpg" alt="">
   </div>
