...
<head>
   ...
   <title>Open kitchen BBQ Restaurant</title>
   ...
   <link rel="stylesheet" href="css/RestaurantsHome.css">
...
<section class="header">
   ...
   <a href="#" class="logo"> <i class="fas fa-utensils"></i> Open Kitchen Restaurant</a>
...
<section class="home" id="home">
   ...
   <div class="swiper home-slider">
      ...
      <div class="swiper-wrapper">
         ...
         <div class="swiper-slide slide" style="background: url(Images/openkitchenhome-slide-1.jpg) no-repeat;">
            <div class="content">
               <span>Open Kitchen BBQ Restaurant</span>
               <h3>delicious cooking</h3>
               <a href="#" class="btn">get started</a>
            </div>
         </div>

         <div class="swiper-slide slide" style="background: url(Images/openkitchenhome-slide-2.jpg) no-repeat;">
            <div class="content">
               <span>oOpen Kitchen BBQ Restaurant</span>
               <h3>morning moment</h3>
               <a href="#" class="btn">get started</a>
            </div>
         </div>

         <div class="swiper-slide slide" style="background: url(Images/openkitchenhome-slide-3.jpg) no-repeat;">
            <div class="content">
               <span>Open Kitchen BBQ Restaurant</span>
...
<section class="about" id="about">
   ...
   <div class="image">
      <img src="Images\Open Kitchen.jpg" alt="">
   </div>

   <div class="content">
      <h3 class="title">Welcome to our restaurant</h3>
      <p>blah blah blah blahhhhhhhhhhhhhhhhhhhhhhhhhh</p>
      <div class="icons-container">
         <div class="icons">
            <img src="images/openkitchenabout-icon-1.png" alt="">
            <h3>quality food</h3>
         </div>
         <div class="icons">
            <img src="images/openkitchenabout-icon-2.png" alt="">
            <h3>food & drinks</h3>
         </div>
         <div class="icons">
            <img src="images/openkitchenabout-icon-3.png" alt="">
            <h3>expert chefs</h3>
         </div>
      </div>
   </div>
...
<section class="footer">
   ...
   <div class="icons-container">
      ...
      <div class="icons">
         ...
         <h3>email</h3>
         <p>openkitchenbbq@gmail.com</p>
      </div>

      <div class="icons">
         <i class="fas fa-map"></i>
         <h3>address</h3>
         <p>kuttikkanam, india</p>
      </div>
...
<!-- custom js file link  -->
<script src="js/openkitchen.js"></script>
